...
<form:form class="form-horizontal" modelAttribute="product" action="${pageContext.request.contextPath}/manageProduct/updateProd" method="post" enctype="/multipart/form-data">
		<fieldset>
