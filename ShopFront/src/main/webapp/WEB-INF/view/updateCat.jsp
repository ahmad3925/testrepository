...
<form:form class="form-horizontal" modelAttribute="category" action="${pageContext.request.contextPath}/manageProduct/updateCat" method="post" enctype="/multipart/form-data">
		<fieldset>
