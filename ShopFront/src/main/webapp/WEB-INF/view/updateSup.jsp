...
<form:form class="form-horizontal" modelAttribute="supplier" action="${pageContext.request.contextPath}/manageProduct/updateSup" method="post" enctype="/multipart/form-data">
		<fieldset>
